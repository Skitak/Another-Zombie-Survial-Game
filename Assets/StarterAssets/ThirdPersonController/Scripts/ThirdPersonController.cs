...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            // Vector3 targetMoveRotation = Quaternion.AngleAxis(_targetRotation, Vector3.up) * inputDirection;
            // move the player
            _controller.Move(
                // targetDirection.normalized * (_speed * Time.deltaTime) +
                (Quaternion.AngleAxis(_mainCamera.transform.eulerAngles.y, Vector3.up) * inputDirection) * (_speed * Time.deltaTime) +
            ...
            float cameraXRotation = _mainCamera.transform.eulerAngles.x;
            if (cameraXRotation > 180)
                cameraXRotation -= 360;
            float torsoAnimParam = Mathf.InverseLerp(minRotation, maxRotation, cameraXRotation);
            if (_hasAnimator)
            {
